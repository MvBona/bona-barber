...
const translations = {
  pt: {
    ...
    reminder2h: (hora, nome) => `Seu horário é em 1 hora, às ${hora} na ${nome}.`,
  ...
  es: {
    ...
    reminder2h: (hora, nome) => `Tu turno es en 1 hora, a las ${hora} en ${nome}.`,
  ...
  en: {
    ...
    reminder2h: (hora, nome) => `Your appointment is in 1 hour, at ${hora} at ${nome}.`,
